...
describe('CarOnSaleClient', () => {
    ...
    describe('getRunningAuctions', () => {
      ...
      nock.cleanAll();
        ...
        it('should throw an error with status code 401', async () => {
            ...
            const carOnSaleClient = new CarOnSaleClient()
            try {
                await carOnSaleClient.getRunningAuctions('token-test', 'salesman@random.com')
            } catch (error) {
    ...
    describe('authService', () => {
        it('should return the user information', async () => {
            ...
            const carOnSaleClient = new CarOnSaleClient()
            const result = await carOnSaleClient.authService('salesman@random.com', '123test')
        ...
        it('should throw an error with status code 401', async () => {
            ...
            try {
                const carOnSaleClient = new CarOnSaleClient()
                await carOnSaleClient.authService('salesman@random.com', '123test-wrong')
            } catch (error) {
        ...
        it('should throw an error with status code 400', async () => {
            ...
            try {
                const carOnSaleClient = new CarOnSaleClient()
                await carOnSaleClient.authService('salesman@randomtest.com', '123test')
            } catch (error) {
